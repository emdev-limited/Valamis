...
<c:if test="<%= themeDisplay.isShowSiteAdministrationIcon() %>">
    ...
    <div class="adminBanner hideBanner" id="<portlet:namespace />Banner">
        This is Valamis CE version - No support - No warranty - <a target="_blank" href="http://www.liferay.com/marketplace/-/mp/application/35268197">Update to EE version</a>
