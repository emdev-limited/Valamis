...
public class LFObjectiveLocalServiceClpInvoker {
    ...
    public LFObjectiveLocalServiceClpInvoker() {
        ...
        _methodName206 = "createLFObjective";

        _methodParameterTypes206 = new String[] {  };

        _methodName207 = "findBySequencingIDAndIsPrimary";

        _methodParameterTypes207 = new String[] { "java.lang.Integer", "boolean" };

        _methodName208 = "findBySequencingIDAndIsPrimaryAndIdentifier";
