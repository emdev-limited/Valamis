gradebook.module('Views.AttemptsList', function (AttemptsList, gradebook, Backbone, Marionette, $, _) {
  ...
  AttemptsList.AttemptsCollectionView = gradebook.Views.ItemsCollectionView.extend({
    ...
    templateHelpers: function() {
      ...
      if (!gradebook.viewAll) {
        ...
        _.extend(params, {
          ...
          lessonFeedbackFouUser: (gradeModel) ? gradeModel.comment : ''
        });
      }
    ...
    sendGrade: function(data) {
      this.model.set({ teacherGrade: data.grade, comment: data.comment });
      this.model.setLessonGrade({}, { userId: this.options.userId });
    },
