...
var CertificateItemView = Backbone.View.extend({
    ...
    openDetails: function () {
        this.trigger('editCertificateDetails', {id: this.model.id, status: this.model.get('status'), isJoint: this.viewType == VIEW_TYPE.MY_COLLECTION});
    },
    openGoals: function () {
    ...
    confirmUnpublishCertificate: function () {
        var confirmView = new DeleteConfirmationView({
            language: this.language,
            template: '#certificateUnpublishConfirmationTemplate'
        });
