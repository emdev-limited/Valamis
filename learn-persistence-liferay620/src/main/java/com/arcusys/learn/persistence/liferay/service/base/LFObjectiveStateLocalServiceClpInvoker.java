...
public class LFObjectiveStateLocalServiceClpInvoker {
    ...
    public LFObjectiveStateLocalServiceClpInvoker() {
        ...
        _methodName206 = "createLFObjectiveState";

        _methodParameterTypes206 = new String[] {  };

        _methodName207 = "findByMapKeyAndActivityStateID";

        _methodParameterTypes207 = new String[] {
                "java.lang.String", "java.lang.Integer"
            };

        _methodName208 = "findByActivityStateID";
        ...
        _methodName210 = "getLFObjectiveState";
