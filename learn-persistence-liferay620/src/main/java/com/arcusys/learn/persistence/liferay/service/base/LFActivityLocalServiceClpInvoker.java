...
public class LFActivityLocalServiceClpInvoker {
    ...
    public LFActivityLocalServiceClpInvoker() {
        ...
        _methodName206 = "createLFActivity";

        _methodParameterTypes206 = new String[] {  };

        _methodName207 = "findByPackageAndID";
        ...
        _methodName209 = "findByPackageIDAndOrganizationID";

        _methodParameterTypes209 = new String[] {
                "java.lang.Integer", "java.lang.String"
            };

        _methodName210 = "findByPackageIDAndParentID";
