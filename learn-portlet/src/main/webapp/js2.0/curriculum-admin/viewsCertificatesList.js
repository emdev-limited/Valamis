curriculumManager.module('Views.CertificatesList', function (CertificatesList, CurriculumManager, Backbone, Marionette, $, _) {
  ...
  CertificatesList.CertificatesItemView = Marionette.ItemView.extend({
    ...
    events: {
      ...
      'click .dropdown-menu > li.js-publish-certificate': 'publishCertificate',
      'click .dropdown-menu > li.js-unpublish-certificate': 'confirmUnpublish',
      'click .dropdown-menu > li.js-delete-certificate': 'confirmDelete',
      'click .dropdown-menu > li.js-export-certificate': 'exportCertificate'
    },
    modelEvents: {
      'change:isPublished': 'render',
      'itemSaved': 'render'
    },
    behaviors: {
      ValamisUIControls: {}
    ...
    onRender: function() {
      this.$el.toggleClass('unpublished', !(this.model.get('isPublished')));
    },
    ...
    confirmUnpublish: function() {  // todo rename it to valamis:confirm
      var that = this;
      valamisApp.execute('delete:confirm', { message: Valamis.language['warningUnpublishCertificateMessageLabel'] }, function(){
        that.unpublishCertificate();
      });
    },
    ...
    confirmDelete: function() {
      var that = this;
      valamisApp.execute('delete:confirm', { message: Valamis.language['warningDeleteCertificateMessageLabel'] }, function(){
