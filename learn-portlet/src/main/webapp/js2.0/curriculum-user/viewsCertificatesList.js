curriculumUser.module('Views.CertificateList', function (CertificatesList, CurriculumUser, Backbone, Marionette, $, _) {
  ...
  CertificatesList.CertificatesItemView = Marionette.ItemView.extend({
    ...
    confirmLeave: function() {
      var that = this;
      valamisApp.execute('delete:confirm', { message: Valamis.language['warningLeaveCertificateMessageLabel'] }, function(){
  ...
  CertificatesList.AppLayoutView = Marionette.LayoutView.extend({
    ...
    onRender: function() {
      var myCertificatesCollection = new curriculumUser.Entities.CertificateCollection([], { available: false });
      ...
      var availableCollection = new curriculumUser.Entities.CertificateCollection([], { available: true });
      ...
      this.$('#certificateCollectionTabs a[href="#myCertificates"]').on('shown.bs.tab', function () {
        myCertificatesView.fetchCollection(true);
      });
      this.$('#certificateCollectionTabs a[href="#availableCertificates"]').on('shown.bs.tab', function () {
        availableCertificatesView.fetchCollection(true);
      });
    },
    onShow: function() {
      this.$('#certificateCollectionTabs a[href="#myCertificates"]').tab('show');
    }
  });
