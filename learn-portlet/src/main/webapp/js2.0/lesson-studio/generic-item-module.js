var GenericEditorItemModule = Marionette.Module.extend({
    ...
    BaseView: Marionette.ItemView.extend({
        ...
        behaviors: {
            ...
            ImageUpload: {
                ...
                'contentType': function (model) {
                    return (model.get('slideEntityType') === 'webgl') ? 'webgl': 'icon';
                }
            }
        },
        ...
        onFileAdded: function(file, data) {
            ...
            this.updateUrl(fileUrl, oldContent, undf, undf, undf, true);
        ...
        initialize: function(options) {
            ...
            if(isNaN(content) && content.indexOf('blob:') != -1 && navigator.sayswho[0].toLowerCase() === 'chrome')
        ...
        updateEl: function() {
            ...
            if (_.contains(['content', 'question', 'plaintext'], this.model.get('slideEntityType'))) {
            ...
            this.ui.controls.toggle(this.model.get('active') && !this.model.get('selected') && this.$el.find('.lesson-summary-text').size() == 0);
            if (this.ui.content.find('#lesson-summary-table').html()) {
                this.ui.content.addClass('lesson-summary-text');
            }
            ...
            this.$el.resizable({
                ...
                stop: function (event, ui) {
                    ...
                    if (that.model.get('slideEntityType') == 'text') {
                        that.wrapperUpdate(!slidesApp.isEditing);
                    }
